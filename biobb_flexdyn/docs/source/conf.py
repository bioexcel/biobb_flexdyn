...
htmlhelp_basename = 'biobb_flexserv_doc'
...
latex_documents = [
    (master_doc, 'biobb_flexserv.tex', u'biobb_flexserv Documentation',
...
man_pages = [
    (master_doc, 'biobb_flexserv', u'biobb_flexserv Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'biobb_flexserv', u'biobb_flexserv Documentation',
     author, 'biobb_flexserv', 'biobb_flexserv template building block',
     'Miscellaneous'),
]
